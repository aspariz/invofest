            ...
            <section className="w-full  mt-20 relative z-10">
                <div className="max-w-7xl ">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 ">
                        <Card>
                            <h3 className="text-xl font-semibold mb-3">IT Seminar</h3>
                        ...
                        <Card>
                            <h3 className="text-xl font-semibold mb-3">IT Talkshow</h3>
                            <p className="text-slate-600 text-sm mb-4">
                        ...
                        <Card>
                            <h3 className="text-xl font-semibold mb-3">IT Competition</h3>
                            <p className="text-slate-600 text-sm mb-4">
                                Kompetisi "From Creation to Innovation" mengajak generasi muda untuk mengembangkan inovasi dan kreativitas guna membentuk kelompok yang memiliki potensi luar biasa, yang mampu mewujudkan masa depan.
                            </p>
                            <Button
                                className="w-full text-xs"
                                label="INFO SELENGKAPNYA"
                        ...
                        <Card>
                            <h3 className="text-xl font-semibold mb-3">IT Workshop</h3>
                            <p className="text-slate-600 text-sm mb-4">
